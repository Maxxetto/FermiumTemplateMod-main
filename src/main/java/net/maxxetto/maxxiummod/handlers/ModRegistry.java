...
import net.maxxetto.maxxiummod.item.ItemExampleArmor;
import net.maxxetto.maxxiummod.potion.PotionExample;
import net.maxxetto.maxxiummod.recipe.RecipeExample;

@Mod.EventBusSubscriber(modid = MaxxiumMod.MODID)
public class ModRegistry {

        public static ItemArmor.ArmorMaterial EXAMPLE_ARMOR = EnumHelper.addArmorMaterial("example_armor", MaxxiumMod.MODID + ":example_armor", 26, new int[]{2,4,6,2}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F);
        ...
        public static PotionType examplePotion = new PotionType("example", new PotionEffect(PotionExample.INSTANCE)).setRegistryName(new ResourceLocation(MaxxiumMod.MODID, "example"));
        ...
        public static void registerRecipeEvent(RegistryEvent.Register<IRecipe> event) {
                event.getRegistry().register(new RecipeExample().setRegistryName(new ResourceLocation(MaxxiumMod.MODID, "example")));
        }
