package net.maxxetto.maxxiummod.potion;
...
public abstract class PotionBase extends Potion {
    ...
    public PotionBase(String name, boolean isBadEffect, int liquidColor) {
        ...
        this.texture = new ResourceLocation(MaxxiumMod.MODID, "textures/effects/" + name + ".png");
        this.setRegistryName(MaxxiumMod.MODID, name);
        this.setPotionName("effects." + MaxxiumMod.MODID + "." + name);
    }
